...
class EstablishmentProfile(models.Model):
    ...
    logo_small = models.ImageField(upload_to='establishment/', blank=True, null=True)
    site_favicon = models.ImageField(upload_to='establishment', blank=True, null=True)
    site_header = models.CharField(
         help_text='Entete de la page Admin',
         max_length=100,
         default='Sup-Management Mauritanie'
    )
    site_title = models.CharField(
            help_text = 'Title of our site ',
            max_length=80,
            default = "Sup-Management-Mauritanie"

    )
    index_title = models.CharField(
            help_text='Super Admin dashboard listing pages',
            max_length=100,
            default='Sup Management Mauritanie Admin'
    ...
    def get_absolute_url(self):
        return reverse('establishment:establishment_detail', args=[self.pk])
...
class BaseWidget(TimeStampedModel):
    ...
    didget_number = models.PositiveSmallIntegerField(unique=True)
